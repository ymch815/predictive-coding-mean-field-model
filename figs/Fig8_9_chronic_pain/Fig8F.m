% Fig 8F: barplot for comparison of Ave. ACC synaptic variable of subpopulations
% under low stimulus
...
bar_plot(peakarr_n,peakarr_c,0.075,[0.6,0.37],{'****','  ns'},...
    {'w/ S1 (N)','w/ S1 (C)','w/o S1 (N)','w/o S1 (C)'},'Ave. synaptic activ. (a.u.)',{[0 0.4470 0.7410;...
