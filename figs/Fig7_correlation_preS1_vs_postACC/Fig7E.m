% Fig 7E: correlation between preS1 and post ACC (placebo)
clear all 
close all
warning off 
...
% load directly
data = load('cor_placebo.mat');
xarr = data.xarr;
preS1 = data.preS1; 
postACC = data.postACC; 

% calculate data
% [xarr,recell,~] = trials('naive', 'placebo', 'no feedback', {'preS1','postACC'}, plot_dynamics,...
...
% % % save('cor_placebo.mat','xarr','preS1','postACC')